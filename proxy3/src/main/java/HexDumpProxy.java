...
public final class HexDumpProxy {
    ...
    static final int REMOTE_PORT = Integer.parseInt(System.getProperty("remotePort", "11182"));
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            String[] remote_hosts = {"localhost"};
            int[] remote_ports = new int[]{10511, 10512, 10513};
